...
<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="active"><a href="#enquiries" aria-controls="outlined" role="tab" data-toggle="tab">Enquiries</a></li>
	<li role="presentation"><a href="#contents" aria-controls="colors" role="tab" data-toggle="tab">Contents</a></li>
...
<div class="tab-content p-md">
	...
	<div role="tabpanel" class="tab-pane in active fade" id="enquiries">

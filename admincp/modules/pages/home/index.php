...
<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="active"><a href="#gallery" aria-controls="colors" role="tab" data-toggle="tab">Gallery</a></li>
...
<div class="tab-content p-md">
	...
	<div role="tabpanel" class="tab-pane in active fade" id="gallery">

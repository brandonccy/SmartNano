...
<div class="table-responsive">
	...
	<table id="default-datatable" data-plugin="DataTable" class="table table-striped" cellspacing="0" width="100%">
		...
		<tbody>
			<?php
			$strNumber="";
			$result=getTable("db_gallery", "WHERE image_stat<>'3' AND page_slug='gallery'");
			foreach ($result as $row) {
				$strNumber++;
  			?>
  			<tr>
  				<td><?=$strNumber?></td>
          <td><div style="width:40px;height:40px;"><img src="<?=$row["image_thumb"]?>" style="object-fit: cover;width:100%;height:100%" onclick="viewImage('<?=$row["image_url"]?>')"></div></td>
  				<td>
          <input type="text" id="url-<?=$row["image_id"]?>" value="<?=$row["image_url"]?>" style="width:100%;border:0px;" data-lightbox="gallery-1" data-title="gallery image">    
          </td>
  				<td>
...
<input type="hidden" name="form" value="pages-gallery-deleteImage">
        ...
        <div class="widget-body">
          <div class="row">
            <form action="" id="uploadImageGallery" class="form-horizontal" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="form" value="pages-gallery-uploadImageGallery">

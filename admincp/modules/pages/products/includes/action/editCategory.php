<?php
$txtTitle=getDataTable("db_products_cate", "cate_id", $id, "cate_name");
$txtURLSlug=getDataTable("db_products_cate", "cate_id", $id, "cate_slug");
?>
...
<div class="widget-body">
	...
	<form action="#" class="form-horizontal" method="post" data-parsley-validate>
		...
		<input type="hidden" name="form" value="pages-products-editCategory">
